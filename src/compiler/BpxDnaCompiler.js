...
import { Genome } from '../bundle/behaveplus/genome/genome.js'
import * as Lib from '../bundle/behaveplus/equations/index.js'
import * as Variant from '../bundle/behaveplus/variants/index.js'
...
export class DnaCompiler {
  ...
  imports () {
    return '/* eslint-disable comma-spacing, indent, comma-dangle, quotes, no-unused-vars */\n' +
      '// autogenerated by BpxDnaCompiler.js on ' + new Date().toLocaleString() + '\n' +
...
compiler.run(Genome, './src/bundle/behaveplus/BpxDna.js')
